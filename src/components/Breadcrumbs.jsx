...
const Breadcrumbs = () => {
  ...
  return (
    <nav className="flex px-4 py-2 bg-gray-100 mt-20" aria-label="Breadcrumb ">
          ...
          return (
            <li key={routeTo} aria-current={isLast ? "page" : undefined}>
              <div className="flex items-center">
                ...
                {isLast ? (
                  <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400 capitalize">{decodeURIComponent(path)}</span>
                ) : (
                  <Link
                    to={routeTo}
